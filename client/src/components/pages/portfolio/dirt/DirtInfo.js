...
const DirtInfo = ({changeProject}) => {
  return (
      <div className="project-info-con">
        <button onClick={() => changeProject("all")} className="back-btn">Back to projects</button>
        <h4 className="project-title">Dirt</h4>
        ...
        {/* <button className="back-to-top">
          <img src="/assets/icons/arrow-up.svg" alt="Back to the top"/>
        </button> */}
      </div>
  )
}
...
export default connect(null, {changeProject})(DirtInfo);
